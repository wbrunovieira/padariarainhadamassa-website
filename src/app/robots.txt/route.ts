...
export async function GET(request: Request) {
  ...
  const corpo = fechado
    ...
    : [
        ...
        "Disallow: /api/",
        "",
        "# /cardapio e /admin nao entram aqui de proposito: os dois saem do",
        "# indice pelo noindex, e para isso o rastreador precisa poder ler a",
        "# pagina. Bloquear no robots faria o contrario -- o Google nunca",
        "# leria o noindex, e a URL poderia aparecer nua no resultado.",
        "",
