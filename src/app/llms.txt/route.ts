...
export async function GET() {
  ...
  const linhas = [
    ...
    "## Encomendas",
    "",
    `Combinadas por telefone ou WhatsApp (${site.phone}) e retiradas na loja.`,
    "",
    ...
    "## Observações",
    "",
    `- Delivery pelos aplicativos ${deliveryTexto}. Encomenda de bolo, torta e salgado é por telefone ou WhatsApp, com retirada na loja.`,
