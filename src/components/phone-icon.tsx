/**
 * Ícone de telefone em SVG embutido.
 *
 * Mesmo motivo do `whatsapp-icon.tsx`: vive em dois lugares — o botão do
 * cabeçalho e o das encomendas — então mora aqui em vez de duplicado nos dois.
 */
