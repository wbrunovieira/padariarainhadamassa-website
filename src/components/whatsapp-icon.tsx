/**
 * O glifo do WhatsApp em SVG embutido.
 *
 * O lucide-react não traz ícones de marca (foram removidos da biblioteca),
 * e o ícone vive em dois lugares — o botão das encomendas e o flutuante —
